        ...
        <div class="flex items-stretch h-screen">  
            <div class="w-full md:w-1/2 bg-white p-6 md:p-10 flex flex-col justify-center shadow-lg min-h-screen">  
                <div class="w-11/12 sm:w-3/4 md:w-1/2 mx-auto mt-16">  
                    ...
                    <form action="User" method="post" class="mt-4 md:mt-6 grid grid-cols-1 md:grid-cols-2 gap-4">  
                        <input type="hidden" name="action" value="add" />  
                        <div class="mb-4">  
                            <label for="nim" class="block mb-1 md:mb-2 text-sm font-medium text-zinc-700">NIM</label>  
                            <input type="text" name="nim" id="nim" required class="border border-zinc-300 rounded-lg p-2 md:p-4 w-full" placeholder="Masukkan NIM Anda" />  
                        </div>  
                        <div class="mb-4">  
                            <label for="name" class="block mb-1 md:mb-2 text-sm font-medium text-zinc-700">Nama</label>  
                            <input type="text" name="name" id="name" required class="border border-zinc-300 rounded-lg p-2 md:p-4 w-full" placeholder="Masukkan Nama Anda" />  
                        </div>  
                        <div class="mb-4">  
                            <label for="email" class="block mb-1 md:mb-2 text-sm font-medium text-zinc-700">Email</label>  
                            <input type="email" name="email" id="email" required class="border border-zinc-300 rounded-lg p-2 md:p-4 w-full" placeholder="Masukkan Email Anda" />  
                        </div>  
                        <div class="mb-4">  
                            <label for="jurusan" class="block mb-1 md:mb-2 text-sm font-medium text-zinc-700">Jurusan</label>  
                            <input type="text" name="jurusan" id="jurusan" required class="border border-zinc-300 rounded-lg p-2 md:p-4 w-full" placeholder="Masukkan Jurusan Anda" />  
                        </div>  
                        <div class="mb-4">  
                            <label for="fakultas" class="block mb-1 md:mb-2 text-sm font-medium text-zinc-700">Fakultas</label>  
                            <input type="text" name="fakultas" id="fakultas" required class="border border-zinc-300 rounded-lg p-2 md:p-4 w-full" placeholder="Masukkan Fakultas Anda" />  
                        </div>  
                        <div class="mb-4">  
                            <label for="phone" class="block mb-1 md:mb-2 text-sm font-medium text-zinc-700">Nomor Telepon</label>  
                            <input type="tel" name="phone" id="phone" required class="border border-zinc-300 rounded-lg p-2 md:p-4 w-full" placeholder="Masukkan Nomor Telepon Anda" />  
                        </div>  
                        <div class="mb-4">  
                            <label for="password" class="block mb-1 md:mb-2 text-sm font-medium text-zinc-700">Password</label>  
                            <input type="password" name="password" id="password" required class="border border-zinc-300 rounded-lg p-2 md:p-4 w-full" placeholder="Masukkan Password Anda" />  
                        </div>  
                        <div class="col-span-2">  
                            <button type="submit" class="bg-blue-600 text-white hover:bg-blue-700 p-2 md:p-3 rounded-lg w-full transition duration-200">Daftar</button>  
                        </div>  
                    </form>  
