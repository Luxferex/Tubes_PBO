...
<body class="bg-gray-100 p-6">
    <div class="max-w-lg mx-auto bg-white p-6 rounded-lg shadow-md">
        <h2 class="text-2xl font-bold mb-6 text-center">Tambah Jurnal</h2>
        <form action="Jurnal" method="post">
            <input type="hidden" name="action" value="add">
            <input type="hidden" name="type" value="jurnal">

            <div class="mb-4">
                <label class="block text-sm font-medium text-gray-700">ID Jurnal:</label>
                <input type="text" name="idJurnal" required class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm focus:ring focus:ring-blue-500">
            </div>
            <div class="mb-4">
            ...
            <div class="flex justify-center">
                <button type="submit" class="bg-blue-500 text-white font-bold py-2 px-4 rounded hover:bg-blue-700">Tambah Jurnal</button>
            </div>
        </form>
    </div>
</body>
