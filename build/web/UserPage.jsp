        ...
        <div class="flex mt-[80px]">    
            <div class="bg-gray-800 text-white p-4 fixed h-full w-64 overflow-y-auto pt-40">    
                <div class="flex items-center space-x-4 mb">  
                    <div class="mx-10">  
                        <img src="images/default.png" alt="Administrator" class="w-20 h-20 rounded-full mb-5">  
                        <%
                            User user = (User) request.getSession().getAttribute("user"); // Ambil user dari session  
                            if (user != null) {
                        %>  
                        <div class="font-bold mx-3"><%= user.getName()%></div>  
                        <div class="text-sm text-gray-400 mx-4"><%= user.getRole()%></div>  
                        <div class="font-semibold mx-5">ID :<%= user.getNim()%></div>  
